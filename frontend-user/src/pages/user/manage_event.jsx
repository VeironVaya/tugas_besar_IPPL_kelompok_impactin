...
const ManageEventPage = () => {
  ...
  const eventDetail = {
    ...
    date: "April, 2025",
    maxCapacity: 70, // 🔥 Kuota maksimum
  };

  // Dummy applicants – nanti ganti API
  ...
  const handleCloseEvent = () => {
    alert("Event Closed (dummy)");
  };

  const handleCancelEvent = () => {
    alert("Event Cancelled (dummy)");
  };

  return (
    <div className="min-h-screen bg-green-50 p-6">
      <div className="max-w-[1500px] mx-auto bg-white p-10 rounded-xl shadow-lg w-full">
        {/* HEADER */}
        <div className="mb-10">
        ...
        {/* FLEX: APPLICANTS & PARTICIPANTS */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* APPLICANTS */}
          <div className="bg-gray-50 p-6 rounded-lg shadow-inner h-[450px] overflow-y-auto">

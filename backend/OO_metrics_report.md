# Laporan Metrik OO
Dihasilkan otomatis oleh scripts/oo_metrics.py dan scripts/generate_report.py
---
## Pengantar
...
---
## Struct teratas berdasarkan WMC (kompleksitas) 
